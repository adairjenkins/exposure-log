...
function AboutPage() {
  return (
    <Box sx={{margin:3, marginTop:12, marginBottom:15}}>
      ...
      repeatedly exposes themselves to the situation while also tracking their pre, peak, and post 
      SUDs (subjective units of distress). Tracking the SUDs provides feedback about the individual’s 
      ...
      <Typography sx={{mt:6, fontWeight:500, fontSize:16}}>
